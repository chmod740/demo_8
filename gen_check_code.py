...
import os
from config import char2pos, pos2char
...
def random_captcha_text(captcha_size=1):
    captcha_text = []
    for i in range(captcha_size):
        c = random.randint(0, 94)
        captcha_text.append(pos2char(c))
    return captcha_text
...
def gen_captcha_text_and_image():
    ...
    captcha_image = captcha_image.resize((40, 64))
